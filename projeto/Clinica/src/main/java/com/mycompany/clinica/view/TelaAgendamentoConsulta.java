            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (texto.length() > 0) {
                    ...
                    if (!pacientes.isEmpty()) {
                        txtPaciente.setText(pacientes.get(0).getNome());
                        txtPaciente.select(texto.length(), pacientes.get(0).getNome().length());
                    }
                }
            }
        });
        ...
        txtMedico.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (texto.length() > 0) {
                    ...
                    if (!medicos.isEmpty()) {
                        txtMedico.setText(medicos.get(0).getNome());
                        txtMedico.select(texto.length(), medicos.get(0).getNome().length());
                    }
                }
            }
        });
    ...
    private void listarConsultas() {
        try {
            ...
            for (Consulta c : consultas) {
                Paciente paciente = buscarPacientePorIdLocal(c.getIdPaciente());
                Medico medico = buscarMedicoPorIdLocal(c.getIdMedico());
